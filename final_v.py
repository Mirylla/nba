...
st.set_page_config(
    page_title="NBA Stats for 2021-2022 hola",
...
def load_data(nrows):
    ...
    filename = '\OneDrive\\Documentos\\MASTER_BIG_DATA\\Vodafone_Elena_Abril\\2021-2022_NBA_Player_Stats.csv'
    ...
    eff = data_df.PTS + data_df.TRB + data_df.AST + data_df.STL + data_df.BLK - data_df.FGM - \
        data_df.FTM - data_df.TOV
...
# Filtering data if the filters are being used
...
with column_1:
    ...
    st.altair_chart(plt1, use_container_width=True)
